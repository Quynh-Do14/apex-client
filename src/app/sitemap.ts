...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticUrls = [
    {
      url: 'https://apexauto.vn/',
      lastModified: new Date(),
      changeFrequency: 'weekly' as const,
      priority: 1,
    },
    {
      url: 'https://apexauto.vn/san-pham',
      lastModified: new Date(),
      changeFrequency: 'daily' as const,
      priority: 0.9,
    },
    {
      url: 'https://apexauto.vn/dai-ly',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.8,
    },
    {
      url: 'https://apexauto.vn/tin-tuc',
      lastModified: new Date(),
      changeFrequency: 'daily' as const,
      priority: 0.9,
    },
    {
      url: 'https://apexauto.vn/lien-he',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.6,
    },
    {
      url: 'https://apexauto.vn/gioi-thieu',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.7,
    },
    // Chính sách pages
    {
      url: 'https://apexauto.vn/chinh-sach/chinh-sach-bao-hanh-doi-tra-hang',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.5,
    },
    {
      url: 'https://apexauto.vn/chinh-sach/chinh-sach-bao-mat',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.5,
    },
    {
      url: 'https://apexauto.vn/chinh-sach/chinh-sach-giao-hang',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.5,
    },
    {
      url: 'https://apexauto.vn/chinh-sach/chinh-sach-mua-hang',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.5,
    },
    {
      url: 'https://apexauto.vn/chinh-sach/chinh-sach-thanh-toan',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.5,
    },
    {
      url: 'https://apexauto.vn/chinh-sach/thong-tin-ve-dieu-kien-giao-dich-chung',
      lastModified: new Date(),
      changeFrequency: 'monthly' as const,
      priority: 0.5,
    },
